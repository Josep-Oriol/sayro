    ...
    <>
      ...
      <div className="container mx-auto px-4 md:px-8 py-24 text-center">
        <div className="flex flex-col items-center">
          <div className="bg-dark-background p-6 rounded-full shadow-lg mb-6">
            <Lock className="text-dark-gold" size={48} />
          </div>
          <h1 className="text-4xl font-extrabold text-dark-gold mb-4">
            Acceso Denegado
          </h1>
